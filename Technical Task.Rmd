...
For both models we get a prediction accuracy of around 86% with which we can identify around 83% of employees who did not finish the class.
Of the 876 employees who did finish the class only around 13% were misclassified as abandoning the class.
These predictions were based on the cutoff of around 40% probability which optimises the accuracy. 

Both the lasso and the glm model showed a high AUC of around .93, further substantiating the model quality. 


There were nine predictors with a significant effect on the dropout probability. 
However, six of them stood out as strong predictors with a much larger z score. 
